<template>
  <div class="dashboard">
    ...
    <el-row :gutter="24" class="stat-row">
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card-clickable chart-stagger" :class="{ 'stat-alert': summary.total_unfixed_vulns > 0 }" @click.native="navigateTo('/vulnerability-scan')">
          <div class="stat-card">
