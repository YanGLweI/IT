...
const routes = [
  ...
  // 管理端
  {
    ...
    children: [
      ...
      { path: 'topology-config', name: 'TopologyConfig', component: () => import('../views/network-security/TopologyConfig.vue'), meta: { title: '拓扑关系配置', enTitle: 'Topology Configuration' } },
      { path: 'topology-graph', name: 'TopologyGraph', component: () => import('../views/network-security/TopologyGraph.vue'), meta: { title: '拓扑图生成', enTitle: 'Topology Generation' } },
