...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'change-management', name: 'ChangeManagement', component: () => import('../views/network-security/ChangeManagement.vue'), meta: { title: '变更管理' } },
      { path: 'vulnerability-scan', name: 'VulnerabilityScan', component: () => import('../views/network-security/VulnerabilityScan.vue'), meta: { title: '漏洞扫描' } },
      { path: 'penetration-test', name: 'PenetrationTest', component: () => import('../views/network-security/PenetrationTest.vue'), meta: { title: '渗透测试' } },
      { path: 'firewall-check', name: 'FirewallCheck', component: () => import('../views/network-security/FirewallCheck.vue'), meta: { title: '防火墙检查' } },
      { path: 'security-rectification', name: 'SecurityRectification', component: () => import('../views/network-security/SecurityRectification.vue'), meta: { title: '安全整改记录' } },
      { path: 'system-hardening', name: 'SystemHardening', component: () => import('../views/system-security/SystemHardening.vue'), meta: { title: '系统加固' } },
      { path: 'patch-update', name: 'PatchUpdate', component: () => import('../views/system-security/PatchUpdate.vue'), meta: { title: '补丁更新' } },
      { path: 'virus-control', name: 'VirusControl', component: () => import('../views/system-security/VirusControl.vue'), meta: { title: '病毒控制' } },
      { path: 'backup-management', name: 'BackupManagement', component: () => import('../views/system-security/BackupManagement.vue'), meta: { title: '备份管理' } },
      ...
      { path: 'user-change-history', name: 'UserChangeHistory', component: () => import('../views/permission/UserChangeHistory.vue'), meta: { title: '变更记录历史' } }
    ]
  }
]
